    ...
    return <BannerBox>
        <div className="w-full max-w-screen-2xl mx-auto">
            <div className="my-20 flex justify-center md:block relative h-80">
                <SpanBox>
                    <img alt="" src="/assets/images/demo/demo3.png" decoding="async" data-nimg="fill" className="duration-700 ease-in-out grayscale blur-2xl scale-110"/>
                </SpanBox>
                <div className="absolute w-40 h-40 md:left-10 -bottom-20 border-4 border-white rounded-full overflow-hidden">
                    <SpanBox>
                        <img alt="" src="/assets/images/demo/avatar.jpg" decoding="async" data-nimg="fill" className="duration-700 ease-in-out grayscale blur-2xl scale-110"/>
                    </SpanBox>
                </div>
                    ...
                    <div className="flex justify-center items-center -space-x-2">
                        ...
                        <a href="/BayBayLucky">
                            <div className="relative shadow-lg inline-block w-10 h-10 border-2 border-white rounded-full overflow-hidden">
                                <SpanBox>
                                    <span></span>
                                    <img alt="" src="/assets/images/demo/avatar1.jpg" decoding="async" data-nimg="responsive" className="duration-700 ease-in-out grayscale blur-2xl scale-110" />
                                </SpanBox>
                            </div>
                        </a>
                        <a href="/BayBayLucky">
