...
export default function DaoBannerFull() {
    return <Box>
        <div className="my-20 relative group h-150">
            <SpanBox>
                <img alt="Olympus DAO" src="/assets/images/demo/banner.jpg" decoding="async" data-nimg="fill"
            ...
            <div className="absolute bottom-0 md:px-20 px-10 md:py-12 py-6 w-full bg-black bg-opacity-50 blur30">
                <div className="flex justify-end">
                    <p className="font-cal tracking-wide text-lg bg-white drop-shadow-lg border-gray-50 border-2 text-black px-5 py-2 rounded-full max-w-max md:-mt-16 md:mb-5 -mt-12">(3, 3)</p>
                </div>
                <h1 className="font-cal text-4xl text-white md:text-5xl lg:text-6xl mb-5 tracking-wide">Olympus DAO</h1>
                <p className="text-gray-200 italic md:text-xl text-md leading-8">The Decentralized Reserve Currency &nbsp;$OHM</p></div>
        </div>
    </Box>
}
